...
st.markdown("""
    ...
    <p style='text-align: center;'>Tải lên ảnh ký hiệu tay để dự đoán chữ cái. Ứng dụng sử dụng TensorFlow + Streamlit + MediaPipe.</p>
...
if uploaded_file:
    ...
    # Kiểm tra có phải ảnh tay không
    if contains_hand(img_bgr):
        ...
        st.warning("⚠️ Ảnh không phát hiện được bàn tay. Vui lòng thử lại với ảnh khác!")
